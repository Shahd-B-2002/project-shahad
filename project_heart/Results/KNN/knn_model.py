...
plt.savefig("result/confusion_matrix_KNN.png")
plt.show()

# Save the predictions to a CSV file
df_preds = pd.DataFrame({'Actual': Y_test.values, 'Predicted': predictions_knn})
df_preds.to_csv("result/predictions_KNN_model.csv", index=False)
